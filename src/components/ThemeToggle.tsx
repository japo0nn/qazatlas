...
const storageKey = 'qazatlas-theme'
...
export function ThemeToggle() {
  const [theme, setTheme] = useState<'light' | 'dark'>(() => {
    ...
    return (localStorage.getItem(storageKey) as 'light' | 'dark') ?? 'light'
  })

  useEffect(() => {
    document.documentElement.classList.toggle('dark', theme === 'dark')
    localStorage.setItem(storageKey, theme)
    window.dispatchEvent(new CustomEvent('qazatlas-theme-change', { detail: { theme } }))
  }, [theme])
